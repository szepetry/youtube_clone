...
class VideoDetail extends StatefulWidget {
  ...
  const VideoDetail({Key key, @required this.detail, @required this.listData})
      : super(key: key);
...
class _VideoDetailState extends State<VideoDetail> {
  ...
  void initState() {
    _controller = YoutubePlayerController(
      initialVideoId: widget.detail.id,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              image: NetworkImage(widget.detail.thumbnail['high']['url']),
              fit: BoxFit.cover)),
        ...
        children: <Widget>[
          Expanded(
            child: ListTile(
              ...
              // ),
              CircleAvatar(
                backgroundImage: NetworkImage(widget.detail.channelPhotoURL),
              ),
              title: Text(
